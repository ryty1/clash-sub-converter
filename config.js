...
export const CONFIG = {
    ...
    proxyGroups: [
        ...
        { name: '⚖️ 负载均衡', type: 'load-balance', proxies: ['☁️ Snippets', '🇭🇰 香港节点', '🇹🇼 台湾节点', '🇯🇵 日本节点', '🇸🇬 狮城节点', '🇰🇷 韩国节点', '🇺🇸 美国节点', '🇬🇧 英国节点', '🇩🇪 德国节点', '🇫🇷 法国节点', '🇳🇱 荷兰节点', '🇦🇺 澳洲节点', '🇨🇦 加拿大节点', '🇮🇳 印度节点', '🇹🇷 土耳其节点', '🇷🇺 俄罗斯节点'], url: 'http://www.gstatic.com/generate_204', interval: 300, strategy: 'round-robin' },
