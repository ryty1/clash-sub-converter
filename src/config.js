...
export const CONFIG = {
    ...
    proxyGroups: [
        ...
        { name: '☁️ Snippets', type: 'select', url: 'http://www.gstatic.com/generate_204', interval: 300, tolerance: 50, filter: '(snippets|Snippets|Sni|sni|Snip|snip)' },
